...
public class windows_10_IE_TNg{
    WebDriver driver;
    Tunnel t;
    ...
    public void setUp(String browserVersion,String platform,String username,String access_key ) throws Exception {    	
		...
		ltOptions.put("build", "Build TestNG Internet Explorer - "+platform);
		ltOptions.put("name", "TC Run TestNG Internet Explorer -" + platform);
    ...
    public void Scenario1() throws InterruptedException {
		...
		softAssert.assertEquals(title, "Lambda Test", "Page Title is not as expected!");
